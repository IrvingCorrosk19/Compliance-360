...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<INotificationContentSecurity, NotificationContentSecurity>();
        ...
        services.AddScoped<IProviderVaultSecretResolver, ConfigurationProviderVaultSecretResolver>();
        services.AddScoped<IProviderEndpointResolver, ProviderEndpointResolver>();
        ...
        services.AddScoped<IProviderCenterService, ProviderCenterService>();
        services.AddScoped<INotificationService, NotificationService>();
        services.AddScoped<INotificationInboxService, NotificationInboxService>();
        services.AddScoped<INotificationTemplateCenterService, NotificationTemplateCenterService>();
        services.AddScoped<IRecipientResolverService, RecipientResolverService>();
        services.AddScoped<IAlertRuleCenterService, AlertRuleCenterService>();
        services.AddSingleton<IAlertScheduleCalculator, AlertScheduleCalculator>();
        ...
        if (!string.IsNullOrWhiteSpace(connectionString))
        {
            ...
            services.AddScoped<IProviderCenterRepository, EfProviderCenterRepository>();
            services.AddScoped<INotificationInboxRepository, EfNotificationInboxRepository>();
            services.AddScoped<INotificationTemplateCenterRepository, EfNotificationTemplateCenterRepository>();
            services.AddScoped<IRecipientResolverRepository, EfRecipientResolverRepository>();
            services.AddScoped<IAlertRuleCenterRepository, EfAlertRuleCenterRepository>();
            services.AddScoped<IAlertSchedulerRepository, EfAlertSchedulerRepository>();
            services.AddScoped<IAlertOperationsRepository, EfAlertOperationsRepository>();
            services.AddScoped<IAlertEventRepository, EfAlertEventRepository>();
            services.AddScoped<EfNotificationQueueRepository>();
            services.AddScoped<INotificationQueueRepository>(provider => provider.GetRequiredService<EfNotificationQueueRepository>());
            services.AddScoped<INotificationOutboxWriter>(provider => provider.GetRequiredService<EfNotificationQueueRepository>());
