...
| Duración | 10 horas |
| Objetivo | Formar usuarios proveedores para colaborar con evidencias y requisitos documentales. |
| Prerrequisitos | Conocer requisitos del cliente y documentación del proveedor. |
...
El `Supplier User` es un perfil formal de Compliance 360 Academy. Su entrenamiento está diseñado para que pueda usar la plataforma sin revisar código fuente, entendiendo módulos, permisos, responsabilidades, riesgos y límites reales del producto.

## ¿Qué responsabilidades tiene?

| Responsabilidad | Dueño | Prioridad | Evidencia esperada |
| --- | --- | --- | --- |
| Entregar documentos | Supplier User | Alta | Evidencia en Audit Trail / reporte / registro |
| Actualizar certificados | Supplier User | Alta | Evidencia en Audit Trail / reporte / registro |
| Responder observaciones | Supplier User | Alta | Evidencia en Audit Trail / reporte / registro |
| Mantener evidencias vigentes | Supplier User | Alta | Evidencia en Audit Trail / reporte / registro |
| Revisar solicitudes | Supplier User | Alta | Evidencia en Audit Trail / reporte / registro |
...
- Mantener evidencias vigentes
- Revisar solicitudes

## ¿Qué no puede hacer?

- Ver información interna del cliente
- Aprobar proveedores
- Modificar evaluación
- Acceder a otros suppliers

## Flujo operativo del rol

```mermaid
flowchart TD
    Login[Login + MFA] --> Dashboard[Dashboard Supplier User]
    Dashboard --> S1[Revisar solicitudes]
    S1 --> S2[Cargar documentos]
    S2 --> S3[Responder rechazos]
    S3 --> S4[Actualizar vigencias]
    S4 --> S5[Confirmar entrega]
    S5 --> Evidence[Audit Trail y evidencia]
    Evidence --> Outcome[Resultado controlado para SupplierUser]
```
...
| Proceso | Supplier User | Tenant Admin | Quality Manager | Support Engineer | Consultora Admin |
| --- | --- | --- | --- | --- | --- |
| Cargar certificado | R/A | I | I | C | C |
| Responder rechazo | R/A | I | I | C | C |
| Actualizar contacto | R/A | I | I | C | C |
| Consultar estado | R/A | I | I | C | C |
| Subir evidencia | R/A | I | I | C | C |
| Renovar documento | R/A | I | I | C | C |
...
| --- | --- | --- | --- |
| Supplier Portal | Uso principal | Diario/Semanal | Ver estado real en Handbook |
...
```mermaid
flowchart LR
    R[Supplier User] --> A[Accountable en responsabilidades asignadas]
...
Preparar el acceso y el entorno de trabajo del rol `Supplier User` para operar sin fricción.
...
| --- | --- | --- |
| Revisar solicitudes | Diario | Validar resultado en dashboard/audit trail |
| Cargar documentos | Diario | Validar resultado en dashboard/audit trail |
| Responder rechazos | Diario | Validar resultado en dashboard/audit trail |
| Actualizar vigencias | Diario | Validar resultado en dashboard/audit trail |
| Confirmar entrega | Diario | Validar resultado en dashboard/audit trail |
...
| --- | --- | --- |
| Documentos pendientes | Monitorear tendencia | Escalar desviaciones |
| Documentos rechazados | Monitorear tendencia | Escalar desviaciones |
| Vencimientos | Monitorear tendencia | Escalar desviaciones |
| Estado homologación | Monitorear tendencia | Escalar desviaciones |
| Solicitudes abiertas | Monitorear tendencia | Escalar desviaciones |

---

# CAPÍTULO 5 - Procesos Paso a Paso

### 5.1 Cargar certificado

**Objetivo:** ejecutar el proceso `Cargar certificado` de forma trazable, segura y alineada con el rol `Supplier User`.
...
3. Abrir el módulo relacionado con `Cargar certificado`.
...
### 5.2 Responder rechazo

**Objetivo:** ejecutar el proceso `Responder rechazo` de forma trazable, segura y alineada con el rol `Supplier User`.
...
1. Iniciar sesión en Compliance 360.
2. Confirmar tenant, rol activo y permisos visibles.
3. Abrir el módulo relacionado con `Responder rechazo`.
4. Revisar dashboard, filtros y estado actual antes de modificar información.
5. Crear, actualizar, aprobar, consultar o ejecutar la acción permitida por el rol.
6. Adjuntar evidencia cuando el proceso lo requiera.
7. Validar resultado esperado y registrar observaciones.
...
**Objetivo:** ejecutar el proceso `Actualizar contacto` de forma trazable, segura y alineada con el rol `Supplier User`.
...
1. Iniciar sesión en Compliance 360.
2. Confirmar tenant, rol activo y permisos visibles.
3. Abrir el módulo relacionado con `Actualizar contacto`.
4. Revisar dashboard, filtros y estado actual antes de modificar información.
5. Crear, actualizar, aprobar, consultar o ejecutar la acción permitida por el rol.
6. Adjuntar evidencia cuando el proceso lo requiera.
7. Validar resultado esperado y registrar observaciones.
...
### 5.4 Consultar estado

**Objetivo:** ejecutar el proceso `Consultar estado` de forma trazable, segura y alineada con el rol `Supplier User`.
...
1. Iniciar sesión en Compliance 360.
2. Confirmar tenant, rol activo y permisos visibles.
3. Abrir el módulo relacionado con `Consultar estado`.
4. Revisar dashboard, filtros y estado actual antes de modificar información.
5. Crear, actualizar, aprobar, consultar o ejecutar la acción permitida por el rol.
6. Adjuntar evidencia cuando el proceso lo requiera.
7. Validar resultado esperado y registrar observaciones.
...
**Objetivo:** ejecutar el proceso `Subir evidencia` de forma trazable, segura y alineada con el rol `Supplier User`.
...
1. Iniciar sesión en Compliance 360.
2. Confirmar tenant, rol activo y permisos visibles.
3. Abrir el módulo relacionado con `Subir evidencia`.
4. Revisar dashboard, filtros y estado actual antes de modificar información.
5. Crear, actualizar, aprobar, consultar o ejecutar la acción permitida por el rol.
6. Adjuntar evidencia cuando el proceso lo requiera.
7. Validar resultado esperado y registrar observaciones.
...
### 5.6 Renovar documento

**Objetivo:** ejecutar el proceso `Renovar documento` de forma trazable, segura y alineada con el rol `Supplier User`.
...
1. Iniciar sesión en Compliance 360.
2. Confirmar tenant, rol activo y permisos visibles.
3. Abrir el módulo relacionado con `Renovar documento`.
4. Revisar dashboard, filtros y estado actual antes de modificar información.
5. Crear, actualizar, aprobar, consultar o ejecutar la acción permitida por el rol.
6. Adjuntar evidencia cuando el proceso lo requiera.
7. Validar resultado esperado y registrar observaciones.
...
### 6.1 Escenario: Certificado vencido

**Contexto empresarial:** el rol `Supplier User` enfrenta el caso `Certificado vencido` dentro de un tenant productivo o de capacitación.
...
### 6.2 Escenario: Documento rechazado

**Contexto empresarial:** el rol `Supplier User` enfrenta el caso `Documento rechazado` dentro de un tenant productivo o de capacitación.
...
### 6.3 Escenario: Nueva solicitud

**Contexto empresarial:** el rol `Supplier User` enfrenta el caso `Nueva solicitud` dentro de un tenant productivo o de capacitación.
...
### 6.4 Escenario: Auditoría proveedor

**Contexto empresarial:** el rol `Supplier User` enfrenta el caso `Auditoría proveedor` dentro de un tenant productivo o de capacitación.
...
### 6.5 Escenario: Evidencia incompleta

**Contexto empresarial:** el rol `Supplier User` enfrenta el caso `Evidencia incompleta` dentro de un tenant productivo o de capacitación.
...
### 6.6 Escenario: Cambio de contacto

**Contexto empresarial:** el rol `Supplier User` enfrenta el caso `Cambio de contacto` dentro de un tenant productivo o de capacitación.
...
### 6.7 Escenario: Renovación anual

**Contexto empresarial:** el rol `Supplier User` enfrenta el caso `Renovación anual` dentro de un tenant productivo o de capacitación.
...
### 6.8 Escenario: Proveedor crítico

**Contexto empresarial:** el rol `Supplier User` enfrenta el caso `Proveedor crítico` dentro de un tenant productivo o de capacitación.
...
### 6.9 Escenario: Solicitud urgente

**Contexto empresarial:** el rol `Supplier User` enfrenta el caso `Solicitud urgente` dentro de un tenant productivo o de capacitación.
...
### 6.10 Escenario: Homologación pendiente

**Contexto empresarial:** el rol `Supplier User` enfrenta el caso `Homologación pendiente` dentro de un tenant productivo o de capacitación.
...
**Situación:** el rol `Supplier User` debe trabajar con `Supplier Portal` en Compliance 360.

A. Validar permisos, tenant, evidencia y estado antes de operar Supplier Portal.
B. Compartir credenciales para acelerar el trabajo sobre Supplier Portal.
C. Omitir Audit Trail porque el proceso Supplier Portal es interno.
...
**Situación:** el rol `Supplier User` debe trabajar con `Supplier Management` en Compliance 360.
...
**Situación:** el rol `Supplier User` debe trabajar con `Storage` en Compliance 360.

A. Omitir Audit Trail porque el proceso Storage es interno.
B. Compartir credenciales para acelerar el trabajo sobre Storage.
C. Validar permisos, tenant, evidencia y estado antes de operar Storage.
...
**Situación:** el rol `Supplier User` debe trabajar con `Notifications` en Compliance 360.

A. Prometer funcionalidad no implementada para Notifications sin aclaración.
...
D. Validar permisos, tenant, evidencia y estado antes de operar Notifications.
...
**Situación:** el rol `Supplier User` debe trabajar con `Audit Trail` en Compliance 360.
...
**Situación:** el rol `Supplier User` debe trabajar con `Cargar certificado` en Compliance 360.

A. Compartir credenciales para acelerar el trabajo sobre Cargar certificado.
B. Validar permisos, tenant, evidencia y estado antes de operar Cargar certificado.
C. Omitir Audit Trail porque el proceso Cargar certificado es interno.
D. Prometer funcionalidad no implementada para Cargar certificado sin aclaración.
...
**Situación:** el rol `Supplier User` debe trabajar con `Responder rechazo` en Compliance 360.

A. Omitir Audit Trail porque el proceso Responder rechazo es interno.
B. Compartir credenciales para acelerar el trabajo sobre Responder rechazo.
C. Validar permisos, tenant, evidencia y estado antes de operar Responder rechazo.
D. Prometer funcionalidad no implementada para Responder rechazo sin aclaración.
...
**Situación:** el rol `Supplier User` debe trabajar con `Actualizar contacto` en Compliance 360.

A. Prometer funcionalidad no implementada para Actualizar contacto sin aclaración.
B. Compartir credenciales para acelerar el trabajo sobre Actualizar contacto.
C. Omitir Audit Trail porque el proceso Actualizar contacto es interno.
D. Validar permisos, tenant, evidencia y estado antes de operar Actualizar contacto.
...
**Situación:** el rol `Supplier User` debe trabajar con `Consultar estado` en Compliance 360.

A. Validar permisos, tenant, evidencia y estado antes de operar Consultar estado.
B. Compartir credenciales para acelerar el trabajo sobre Consultar estado.
C. Omitir Audit Trail porque el proceso Consultar estado es interno.
D. Prometer funcionalidad no implementada para Consultar estado sin aclaración.
...
**Situación:** el rol `Supplier User` debe trabajar con `Subir evidencia` en Compliance 360.

A. Compartir credenciales para acelerar el trabajo sobre Subir evidencia.
B. Validar permisos, tenant, evidencia y estado antes de operar Subir evidencia.
C. Omitir Audit Trail porque el proceso Subir evidencia es interno.
D. Prometer funcionalidad no implementada para Subir evidencia sin aclaración.
...
**Situación:** el rol `Supplier User` debe trabajar con `Renovar documento` en Compliance 360.

A. Omitir Audit Trail porque el proceso Renovar documento es interno.
B. Compartir credenciales para acelerar el trabajo sobre Renovar documento.
C. Validar permisos, tenant, evidencia y estado antes de operar Renovar documento.
D. Prometer funcionalidad no implementada para Renovar documento sin aclaración.
...
**Situación:** el rol `Supplier User` debe trabajar con `RBAC` en Compliance 360.
...
**Situación:** el rol `Supplier User` debe trabajar con `MFA` en Compliance 360.
...
**Situación:** el rol `Supplier User` debe trabajar con `Estado real del módulo` en Compliance 360.
...
**Situación:** el rol `Supplier User` debe trabajar con `Buenas prácticas ISO` en Compliance 360.
...
### 11.1 Ejercicio práctico: Cargar certificado

**Caso:** ejecutar `Cargar certificado` en un tenant de entrenamiento llamado `Academy Demo Tenant`.

**Tareas dentro de Compliance 360:**

1. Iniciar sesión con usuario de entrenamiento del rol `Supplier User`.
...
### 11.2 Ejercicio práctico: Responder rechazo

**Caso:** ejecutar `Responder rechazo` en un tenant de entrenamiento llamado `Academy Demo Tenant`.
...
### 11.3 Ejercicio práctico: Actualizar contacto

**Caso:** ejecutar `Actualizar contacto` en un tenant de entrenamiento llamado `Academy Demo Tenant`.
...
### 11.4 Ejercicio práctico: Consultar estado

**Caso:** ejecutar `Consultar estado` en un tenant de entrenamiento llamado `Academy Demo Tenant`.
...
### 11.5 Ejercicio práctico: Subir evidencia

**Caso:** ejecutar `Subir evidencia` en un tenant de entrenamiento llamado `Academy Demo Tenant`.
...
### 11.6 Ejercicio práctico: Renovar documento

**Caso:** ejecutar `Renovar documento` en un tenant de entrenamiento llamado `Academy Demo Tenant`.
...
- Comprensión del rol `Supplier User`.
...
| Audit Trail | Sí | SUPPLIER.PORTAL | Operar/consultar según alcance del rol |
| Storage | Sí | STORAGE.MANAGE limitado | Operar/consultar según alcance del rol |
| Notifications | Sí | SUPPLIER.PORTAL | Operar/consultar según alcance del rol |
...
| Supplier Management | Sí | SUPPLIER.PORTAL | Operar/consultar según alcance del rol |
...
| Supplier Portal | Sí | SUPPLIER.PORTAL | Operar/consultar según alcance del rol |
