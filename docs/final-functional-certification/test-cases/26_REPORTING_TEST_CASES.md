...
| **Risk** | High |
| **Priority** | P0 |
| **Objective** | Validate RA reports scenario 1 per REGUTRACK operational parity |
...
| **Risk** | High |
| **Priority** | P0 |
| **Objective** | Validate RA reports scenario 2 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Viewer |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | High |
| **Priority** | P0 |
| **Objective** | Validate RA reports scenario 3 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Viewer |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate RA reports scenario 4 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Viewer |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate RA reports scenario 5 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Viewer |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate RA reports scenario 6 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Viewer |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate RA reports scenario 7 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Viewer |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate RA reports scenario 8 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Viewer |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate RA reports scenario 9 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Viewer |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate RA reports scenario 10 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Viewer |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
