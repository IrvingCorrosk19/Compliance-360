...
| **Risk** | High |
| **Priority** | P0 |
| **Objective** | Validate MINSA/CSS scenario 1 per REGUTRACK operational parity |
...
**Detailed Steps:**
   1. Navigate to Authorities view
...
| **Risk** | High |
| **Priority** | P0 |
| **Objective** | Validate MINSA/CSS scenario 2 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Administrator |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | High |
| **Priority** | P0 |
| **Objective** | Validate MINSA/CSS scenario 3 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Administrator |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate MINSA/CSS scenario 4 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Administrator |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate MINSA/CSS scenario 5 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Administrator |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate MINSA/CSS scenario 6 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Administrator |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate MINSA/CSS scenario 7 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Administrator |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate MINSA/CSS scenario 8 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Administrator |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
