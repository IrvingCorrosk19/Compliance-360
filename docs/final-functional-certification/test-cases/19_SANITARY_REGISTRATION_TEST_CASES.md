...
**Catalog:** `19_SANITARY_REGISTRATION.md`  
**Cases:** 12  
**Date:** 2026-07-14  
...
| **Module** | CT/RS |
| **Feature** | Sanitary registration |
| **Role** | Regulatory Approver |
| **Permission** | N/A |
| **Risk** | High |
| **Priority** | P0 |
| **Objective** | Validate Sanitary registration scenario 1 per REGUTRACK operational parity |
...
| **Risk** | High |
| **Priority** | P0 |
| **Objective** | Validate Sanitary registration scenario 2 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Approver |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | High |
| **Priority** | P0 |
| **Objective** | Validate Sanitary registration scenario 3 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Approver |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate Sanitary registration scenario 4 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Approver |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate Sanitary registration scenario 5 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Approver |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate Sanitary registration scenario 6 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Approver |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate Sanitary registration scenario 7 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Approver |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate Sanitary registration scenario 8 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Approver |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate Sanitary registration scenario 9 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Approver |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate Sanitary registration scenario 10 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Approver |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate Sanitary registration scenario 11 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Approver |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
...
| **Risk** | Medium |
| **Priority** | P1 |
| **Objective** | Validate Sanitary registration scenario 12 per REGUTRACK operational parity |
| **Preconditions** | Lab bootstrapped; user logged in as Regulatory Approver |
| **Test Data** | Lab tenant ddcaf211-afe0-44a0-9c90-4fbda8fc4871 |
| **Initial State** | Bootstrap completed; SoD baseline GO |
